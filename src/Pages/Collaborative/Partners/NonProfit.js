...
import nonprofit from './../../../images/program/nonprofit.png';
            ...
            <Container className='py-5'>
                <Row className='banner-horizontal'>
                    <Col xs={12} sm={12} md={6} lg={6} xl={6}>
                        <Image src={nonprofit} className='banner-images'/>
                    </Col>
                    <Col xs={12} sm={12} md={6} lg={6} xl={6}>
                        <div className='text-center green horizontal'>
                            ...
                            We partnership with non-profit organizations to help their clients make the right financial decisions i.e., food banks, shelters, and foster homes etc.
                            </p>
                        </div>
                    </Col>
                </Row>
        ...
        <Row>
                ...
                <div className='green-bg text-center pbshadow py-4 mb-5 d-sm-block d-md-none'>
                ...
                </div>
                    {
                        ...
                        <div>
                            <Link to={`/blog/${school.id}`}> <h5 className='post-title'>{school.title}</h5></Link>
