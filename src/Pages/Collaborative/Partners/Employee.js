...
import employee from './../../../images/program/employee.png';
            ...
            <Container className='py-5'>
                <Row className='banner-horizontal'>
                    <Col xs={12} sm={12} md={6} lg={6} xl={6}>
                        <Image src={employee} className='banner-images' style={{width:"60%"}}/>
                    </Col>
                    <Col xs={12} sm={12} md={6} lg={6} xl={6}>
                        <div className='text-center green horizontal'>
                            ...
                            We provide financial education, and leadership training to employees of different organizations. We help them make the right financial decisions, save money, and invest properly.
                            </p>
                        </div>
                    </Col>
                </Row>
