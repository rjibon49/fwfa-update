    ...
    return (
            ...
            <Container className='py-5'>
                <Row className>
                    <Col xs={12} sm={12} md={6} lg={6} xl={6}>
                        <Image src={school} className='images mt-5'/>
                    </Col>
                    <Col xs={12} sm={12} md={6} lg={6} xl={6}>
        ...
        <Row>
                <Col xs={12} sm={12} md={7} lg={8} xl={8}>
                    {
                        schools.map (school => <div className='pb-5 green-bg mb-5 pbshadow me-5' key={school.id}>
                        <div className=''>
                        ...
                        <div>
                            ...
                            <p className='post-details'>{school.details}</p> 
                        </div>
                        <div className='text-center'>
                            <div className='py-2'>
                            <Link to={`/blog/${school.id}`} className=''><i className="fas fa-user-circle mx-2 fs-5 green"></i>{school.category}</Link>
