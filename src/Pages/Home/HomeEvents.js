            ...
            <Row className=''>
                <Col xs={12} sm={12} md={6} lg={6} xl={6}>
                    <div className='mb-5'>
                        ...
                        {
                            evnt.map(evn => <div className='pbshadow' key={evn.id}>
                ...
                <Col xs={12} sm={12} md={6} lg={6} xl={6}>
                    <div className=''>
                        <h3 className='pb-5'>See All Events</h3>
                        <div className='pbshadow'>
                        {
                            evnt.map(evn => <div className='p-3' key={evn.id}>
                                <Row>
                                    <Col xl={4}> 
                                    ...
                                    <Col xl={8}>
                                        <div className='pt-3'>
                                        <Link as={Link} to={`/article1`} className=''> <h3 className='recent-title ps-4' style={{color:"#272d33"}}>{evn.title.slice(0,25)}<span  style={{fontSize:"10px",paddingLeft:"10px"}}>11:30 - 3:00</span></h3></Link>
                                                <div className='pb-1'>
                                                    <p className='black-details'>{evn.details.slice(0, 150)}..<Link as={Link} to={`/article1`} className='e-link'> More Details</Link></p>
                                                </div>
                                                <span className='pe-5' style={{fontSize:"10px", marginLeft:"20px"}}>Sunday, June-06</span>
                                        </div>
                                    </Col>
                                </Row>
                            </div>).slice(1,4)
